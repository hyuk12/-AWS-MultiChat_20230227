...
public class ConnectedSocket extends Thread {
	...
	private Room findRoom(Map<String, String> roomInfo) {
		for(Room r : roomList) {
			if(r.getRoomName().equals(roomInfo.get("roomName")) 
					&& r.getOwner().equals(roomInfo.get("owner"))) {
				return r;
			}
		}
		return null;
	...
	private void sendToAll(ResponseDto<?> responseDto, List<ConnectedSocket> conSockets) {
		for(ConnectedSocket connectedSocket : conSockets) {
